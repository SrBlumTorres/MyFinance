...
const transactionSchema = z.object({
    ...
    date: z.coerce.date({
        invalid_type_error: "El campo date debe ser una fecha válida (ISO 8601 o timestamp)",
    }),
    type: z
    ...
    category: z
        ...
        .int()
        .positive("La categoría debe ser un número positivo"), // La categoría debe ser un entero positivo
    description: z
        .string()
